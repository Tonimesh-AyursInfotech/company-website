...
const OurWorkPage = () => {
  ...
  const brands = [
    "PIZZAHUT", "KFC", "UNO MINDA", "NTT DATA", "PC SOLUTION" , "NEXXORRA"
  ];
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 text-center">
          <div className="max-w-4xl mx-auto">
            <div className="inline-block mb-6">
              <span className="text-sm font-semibold flex items-center gap-1 tracking-wider text-blue-200 uppercase bg-blue-800/50 backdrop-blur-sm px-4 py-2 rounded-full border border-blue-700/30">
                     <CodeSquare className="w-4 h-4 text-blue-300" /> Our Work
            ...
            <button className="inline-flex items-center gap-3 bg-transparent text-white font-semibold px-8 py-4 border border-white rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 group" onClick={()=> {nav("/contactUs")}}>
              Get In Touch
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Discover how we've helped leading brands transform their digital presence and achieve remarkable results.
            </p>
          </div>
